    ...
    <div id="container" class="flex">
        ...
        <div id="content" class="bg-gray-100 w-[85%] mt-[70px] ml-[15%] h-screen">
            <form action="{{ route('category.update', ['category' => $category]) }}" method="POST">
                ...
                <input type="text" name="name" placeholder="Category name" value="{{$category->name}}" class="w-50"><br>
                ...
                @endif
                <button
                    class="bg-red-600 text-white text-sm px-5 py-2.5 mt-2 rounded-md hover:bg-sky-700">UPDATE</button>
            </form>
        </div>
    </div>
